...
{
square1 = new Square(x, y, square1W, square1H, "blue");
square2 = new Square(x2, y2, 60, 60, "green");
}
...
function moveUp() { square1.setY(square1.theY - 10);}
function moveDown() {   square1.setY(square1.theY + 10);}
function moveLeft() {   square1.setX(square1.theX - 10);}
function moveRight() {square1.setX(square1.theX + 10);}
